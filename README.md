...
## Version 2.0
> DB를 이용해 개개인의 계정이 생기고, 예측 서비스를 제공하고있는 주가 중 추가한 주가에 대해서 전날 대비 주가 변동치, 주가 예측 결과, 최근 주가 그래프 정보 제공하는 형태

![무제2](https://github.com/user-attachments/assets/50779c30-ab68-4722-9af8-75daf9bc360a)
